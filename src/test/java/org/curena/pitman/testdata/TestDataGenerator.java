...
public class TestDataGenerator {
    ...
    private static final String[] FIRST_NAMES = {
        "John", "Sarah", "Michael", "Emma", "David", "Jessica", "Robert", "Ashley", "William", "Jennifer",
        "James", "Amanda", "Christopher", "Lisa", "Daniel", "Michelle", "Matthew", "Melissa", "Anthony", "Kimberly"
    };
    ...
    private static final String[] CAT_NAMES = {
        "Whiskers", "Shadow", "Mittens", "Tiger", "Smokey", "Simba", "Oscar", "Felix", "Garfield", "Milo",
    ...
    private static final String[] APPOINTMENT_TYPES = {
        "Routine Checkup", "Vaccination", "Surgery", "Emergency", "Dental Care", "Grooming",
        "X-Ray", "Blood Work", "Spay/Neuter", "Microchipping"
    };
    ...
    private static final String[] APPOINTMENT_REASONS = {
        ...
        "Behavior concerns", "Weight management", "Dental cleaning", "Preventive care", "Follow-up visit"
    };
        ...
        for (Owner owner : owners) {
            ...
            for (int i = 0; i < numPets; i++) {
                ...
                Pet pet = new Pet(
                    ...
                    random.nextInt(15) + 1,
                    species.equals("Dog") ? 10.0 + random.nextDouble() * 80.0 : 3.0 + random.nextDouble() * 15.0,
                    generateColor(),
                    owner.getId(),
    ...
    private static String generateEmail() {
        return randomChoice(FIRST_NAMES).toLowerCase() + "." + randomChoice(LAST_NAMES).toLowerCase() + 
    ...
    private static String generateAddress() {
        return (random.nextInt(9999) + 1) + " " + randomChoice(LAST_NAMES) + " " +
    ...
    private static String generateColor() {
        return randomChoice(new String[]{"Brown", "Black", "White", "Golden", "Gray", "Tan", "Mixed", "Orange", "Cream"});
    }
    ...
    private static String generateAppointmentNotes() {
        String[] notes = {
            "Patient was cooperative", "Owner has questions about diet", "Rescheduled from previous date",
            "Emergency walk-in", "Regular patient", "First visit", "Follow-up appointment"
        };
        return randomChoice(notes);
    }
